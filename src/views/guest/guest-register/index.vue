<!-- 用户注册页 -->
<template>
    <div class="page-guest-register">
        <el-form ref="user" :model="user" :rules="userRules">
            <h2 class="title">注册账号</h2>
            <el-form-item prop="username">
                <el-input v-model="user.username" @keydown.enter.native="onRegister" prefix-icon="el-icon-user"
    ...
    export default {
        ...
        methods: {
            ...
            async submitRegister() {
                ...
                await this.$api.guest.register(this.user, {
